...
public class Home extends JFrame{
    ...
    public Home(String username) {
        super("Tour and Travel Management System");
	...
	NewLabel.setBounds(0, 0, 1600, 1000); 
        ...
        JLabel l1 = new JLabel("Tour and Travel Management System");
	...
	menuBar.add(m5);
        ...
        JMenuItem mi12 = new JMenuItem("PAYMENT");
	m5.add(mi12);
        ...
        JMenu m6 = new JMenu("ABOUT");
        m6.setForeground(Color.BLUE);
	menuBar.add(m6);
        
        JMenuItem mi13 = new JMenuItem("ABOUT");
	m6.add(mi13);
